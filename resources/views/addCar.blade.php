            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('addCar') }}">
                        @csrf
                        <div class="mb-4">
                            <label for="car_name" class="block text-sm font-medium text-green-600">Car Name</label>
                        ...
                        <div class="mb-4">
                            <label for="distance_travelled" class="block text-sm font-medium text-green-600">Distance Travelled</label>
                            <input type="number" name="distance_travelled" id="distance_travelled" 
                                   class="block w-full mt-1 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-blue-500 focus:border-blue-500" 
                                   required>
                        </div>
                        <div class="mb-4">
                            <label for="date_of_purchase" class="block text-sm font-medium text-green-600">Date of Purchase</label>
